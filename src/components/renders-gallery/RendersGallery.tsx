...
const ITEMS: GalleryItem[] = [
  { type: 'image', src: '/images/renders/01 - Living.png', alt: 'Living', natW: 1086, natH: 1448, aspect: 0.7500, heightVh: 55, topVh: 32, gapVh: 5 },
  { type: 'image', src: '/images/renders/02 - Oficina.png', alt: 'Oficina', natW: 1672, natH: 941, aspect: 1.7768, heightVh: 35, topVh: 20, gapVh: 8 },
  { type: 'image', src: '/images/renders/03 - Acceso.png', alt: 'Acceso', natW: 941, natH: 1672, aspect: 0.5627, heightVh: 70, topVh: 20, gapVh: 5 },
  { type: 'image', src: '/images/renders/04 - Dormitorio.png', alt: 'Dormitorio', natW: 1672, natH: 941, aspect: 1.7768, heightVh: 52, topVh: 30, gapVh: 9 },
  { type: 'text', text: 'Renders que anticipan la obra.', topVh: 17, gapVh: 8 },
  { type: 'image', src: '/images/renders/05 - Museo.png', alt: 'Museo', natW: 1296, natH: 1728, aspect: 0.7500, heightVh: 58, topVh: 35, gapVh: 8 },
  { type: 'image', src: '/images/renders/06 - Circulación.png', alt: 'Circulación', natW: 1448, natH: 1086, aspect: 1.3333, heightVh: 46, topVh: 10, gapVh: 10 },
  { type: 'image', src: '/images/renders/07 - Sala de control.png', alt: 'Sala de control', natW: 1448, natH: 1086, aspect: 1.3333, heightVh: 40, topVh: 49, gapVh: 4 },
  { type: 'image', src: '/images/renders/08 - Comedor.png', alt: 'Comedor', natW: 1448, natH: 1086, aspect: 1.3333, heightVh: 55, topVh: 10, gapVh: 10 },
  { type: 'text', text: 'Luz, materialidad y atmósfera.', topVh: 20, gapVh: 8 },
  { type: 'image', src: '/images/renders/09 -  Ascensor.png', alt: 'Ascensor', natW: 941, natH: 1672, aspect: 0.5627, heightVh: 72, topVh: 20, gapVh: 4 },
  { type: 'image', src: '/images/renders/10 - Baño oficina.png', alt: 'Baño oficina', natW: 1390, natH: 1132, aspect: 1.2279, heightVh: 48, topVh: 14, gapVh: 10 },
  { type: 'image', src: '/images/renders/11 - Polideportivo.png', alt: 'Polideportivo', natW: 1467, natH: 1072, aspect: 1.3684, heightVh: 56, topVh: 38, gapVh: 9 },
  { type: 'image', src: '/images/renders/12 - Club náutico.png', alt: 'Club náutico', natW: 4959, natH: 2790, aspect: 1.7774, heightVh: 40, topVh: 16, gapVh: 7 },
  { type: 'image', src: '/images/renders/13 - Hall.png', alt: 'Hall', natW: 1448, natH: 1086, aspect: 1.3333, heightVh: 47, topVh: 42, gapVh: 8 },
  { type: 'text', text: 'Cada proyecto explora una identidad propia.', topVh: 18, gapVh: 8 },
  { type: 'image', src: '/images/renders/14 - Estructura.png', alt: 'Estructura', natW: 941, natH: 1672, aspect: 0.5627, heightVh: 80, topVh: 15, gapVh: 8 },
  { type: 'image', src: '/images/renders/15 - Sala de exposiciones.png', alt: 'Sala de exposiciones', natW: 1920, natH: 1080, aspect: 1.7777, heightVh: 45, topVh: 15, gapVh: 8 },
  { type: 'image', src: '/images/renders/16 - Living.png', alt: 'Living', natW: 1491, natH: 1055, aspect: 1.4132, heightVh: 49, topVh: 45, gapVh: 8 },
  { type: 'text', text: 'Visión convertida en imagen.', topVh: 30, gapVh: 6 },
  { type: 'image', src: '/images/renders/17 - Atelier.png', alt: 'Atelier', natW: 1491, natH: 1055, aspect: 1.4132, heightVh: 38, topVh: 18, gapVh: 4 },
