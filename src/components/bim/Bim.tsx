      ...
      <div className={`${styles.diagramGrid} reveal`}>
        <div className={styles.diagram}>
          ...
          <div className={styles.layer} style={{ opacity: activeLayer === 0 ? 1 : 0 }}>
            <svg viewBox="0 0 800 480" xmlns="http://www.w3.org/2000/svg">
              <g stroke="white" fill="none" opacity="0.7">
                <polygon points="100,360 400,480 700,360 400,240" strokeWidth="1" fill="rgba(255,255,255,0.02)" />
                <polygon points="100,360 100,160 400,40 400,240" strokeWidth="1" fill="rgba(255,255,255,0.04)" />
                <polygon points="700,360 700,160 400,40 400,240" strokeWidth="1" fill="rgba(255,255,255,0.03)" />
                <polygon points="100,160 400,40 700,160 400,280" strokeWidth="1" fill="rgba(255,255,255,0.06)" />
          ...
          <div className={styles.layer} style={{ opacity: activeLayer === 1 ? 1 : 0 }}>
            <svg viewBox="0 0 800 480" xmlns="http://www.w3.org/2000/svg">
              <g stroke="#aaa" fill="none" opacity="0.9">
                ...
                <polygon points="100,260 400,140 700,260 400,380" strokeWidth="1" fill="rgba(200,200,200,0.04)" />
                <line x1="80" y1="370" x2="720" y2="370" strokeWidth="1.5" opacity="0.5" />
              </g>
              <text x="400" y="460" textAnchor="middle" fontFamily="Barlow Condensed, sans-serif" fontSize="11" letterSpacing="3" fill="#666">ESTRUCTURA</text>
            </svg>
          </div>
          {/* Layer 2: MEP */}
          <div className={styles.layer} style={{ opacity: activeLayer === 2 ? 1 : 0 }}>
            <svg viewBox="0 0 800 480" xmlns="http://www.w3.org/2000/svg">
              <g stroke="#888" fill="none">
                ...
                <circle cx="200" cy="180" r="5" strokeWidth="1" fill="rgba(150,150,150,0.2)" />
                <circle cx="400" cy="180" r="5" strokeWidth="1" fill="rgba(150,150,150,0.2)" />
                <circle cx="600" cy="180" r="5" strokeWidth="1" fill="rgba(150,150,150,0.2)" />
                <circle cx="200" cy="220" r="5" strokeWidth="1" fill="rgba(150,150,150,0.2)" />
                <circle cx="400" cy="220" r="5" strokeWidth="1" fill="rgba(150,150,150,0.2)" />
                <circle cx="600" cy="220" r="5" strokeWidth="1" fill="rgba(150,150,150,0.2)" />
              ...
              <text x="400" y="460" textAnchor="middle" fontFamily="Barlow Condensed, sans-serif" fontSize="11" letterSpacing="3" fill="#666">INSTALACIONES MEP</text>
            </svg>
          </div>
          ...
          <div className={styles.layer} style={{ opacity: activeLayer === 3 ? 1 : 0 }}>
            <svg viewBox="0 0 800 480" xmlns="http://www.w3.org/2000/svg">
              ...
              <text x="400" y="460" textAnchor="middle" fontFamily="Barlow Condensed, sans-serif" fontSize="11" letterSpacing="3" fill="#666">ARQUITECTURA + DETALLES</text>
            </svg>
          </div>
        </div>
